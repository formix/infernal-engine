...
exports.engine = function(compil) {
	...
	var engine = {
		 ...
		 * @param {string} ruleName The name given to that rule.
		 * @param {function} rule 
		 * 		The rule to be added to the engine. The function prototype 
		 * 		must be "function(engine)".
		 */
